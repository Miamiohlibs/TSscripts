...
Switch $FUND
	...
	Case "4b "; the macro grabs the first three characters of the fund code (easiest method) so two digit fund codes need to have an extra space for the match
		$SF_NAME = "Baer"
	...
	Case "4r "
		$SF_NAME = "Alumni"
		$SF_590 = "purchased with monies donated by (FILL IN THE BLANK)"
		$SF_7XX = "7911 FILL IN THE BLANK"
