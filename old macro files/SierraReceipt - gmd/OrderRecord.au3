...
TraySetIcon(@DesktopDir & "\SierraReceipt - gmd\Images\blue O.ico")
...
If $REVIEW = 0 Or $LOCATION = "mdli" Or $LOCATION = "mdr" Or $LOCATION = "mdim" Or $LOCATION = "mdju" Or $LOCATION = "mdrs" Then
	Run(@DesktopDir & "\SierraReceipt - gmd\Bib - check ILOC.exe") ;grab item code information related to location code
...
ElseIf $REVIEW = 0 Or $LOCATION = "mdli" Or $LOCATION = "mdr" Or $LOCATION = "mdim" Or $LOCATION = "mdju" Or $LOCATION = "mdrs" Then
	Sleep(0400)
	Run(@DesktopDir & "\SierraReceipt - gmd\Create item - Non DLC.exe");creates item record
Else
	Run(@DesktopDir & "\SierraReceipt - gmd\BibRecord.exe");moves onto bib record function
EndIf
