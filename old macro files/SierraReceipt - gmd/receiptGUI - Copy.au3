...
GUICtrlSetImage(-1, "C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Images\take1_gui.ico")
GUICtrlSetOnEvent($1, "isbntotitle")

$2 = GUICtrlCreateButton("Sample button", 70, 10, 50, 50, $BS_ICON)
GUICtrlSetImage(-1, "C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Images\blue O_gui.ico")
GUICtrlSetOnEvent($2, "order")

$3 = GUICtrlCreateButton("Sample button", 120, 10, 50, 50, $BS_ICON)
GUICtrlSetImage(-1, "C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Images\black B_gui.ico")
GUICtrlSetOnEvent($3, "bib")

$4 = GUICtrlCreateButton("Sample button", 170, 10, 50, 50, $BS_ICON)
GUICtrlSetImage(-1, "C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Images\green D_gui.ico")
GUICtrlSetOnEvent($4, "DLC")

$5 = GUICtrlCreateButton("Sample button", 220, 10, 50, 50, $BS_ICON)
GUICtrlSetImage(-1, "C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Images\red N_gui.ico")
GUICtrlSetOnEvent($5, "nonDLC")

$6 = GUICtrlCreateButton("Sample button", 270, 10, 50, 50, $BS_ICON)
GUICtrlSetImage(-1, "C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Images\stopsign_gui.ico")
...
Func isbntotitle()
	Sleep(0400)
	Run("C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\isbnToTitle.exe")
EndFunc

Func order()
	Sleep(0400)
	Run("C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\OrderRecord.exe")
EndFunc

Func bib()
	Sleep(0400)
	Run("C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\BibRecord.exe")
EndFunc

Func DLC()
	Sleep(0400)
	Run("C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Create Item - DLC.exe")
EndFunc

Func nonDLC()
	Sleep(0400)
	Run("C:\Users\" & @UserName & "\Google Drive\Macros\macroshare\SierraReceipt - gmd\Create item - Non DLC.exe")
EndFunc
