...
If $300_C > 27 Or $300_C_X > 27 Then
	$FOLIO = 1
	If $FOLIO = 1 AND $BIB_LOC_1 = "kngl" AND $300_C > 30 or $300_C_X > 30 Then
				$KNGFO = 1
	ElseIf $FOLIO = 1 AND $BIB_LOC_1 = "scl" AND $300_C > 31 or $300_C_X > 31 Then
				$scfo = 1
	EndIf
EndIf
