...
If $REVIEW = 0 Or $LOCATION = "mdli" Or $LOCATION = "mdr" Or $LOCATION = "mdim" Or $LOCATION = "mdju" Or $LOCATION = "mdrs" Then
	Run(@WorkingDir & "ILOC.exe") ;grab item code information related to location code
...
ElseIf $REVIEW = 0 Or $LOCATION = "mdli" Or $LOCATION = "mdr" Or $LOCATION = "mdim" Or $LOCATION = "mdju" Or $LOCATION = "mdrs" Then
	...
	$nondlc = 1
	_StoreVar("$nondlc")
	Run(@WorkingDir & "ItemCreate");creates item record
Else
	Run(@WorkingDir & "BibRecord.exe");moves onto bib record function
EndIf
